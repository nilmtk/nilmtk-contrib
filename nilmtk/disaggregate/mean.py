...
class Mean(Disaggregator):
    ...
    def partial_fit(self, train_main, train_appliances, **load_kwargs):
        ...
        #print("appliance_in_model ",appliance_in_model)
        for appliance,readings in train_appliances:
            ...
            #data = self._transform_data(readings)
            #print("Readings.................",readings," ",data)
            '''s=[]
            states=[]
            for i in data:
            	s.append(i[0])
            states.append(sum(s)/len(s))	
            print("States ...  ",states)'''
    ...
    def train(self, metergroup, num_states_dict=None, **load_kwargs):
        ...
        * only uses first chunk for each meter (TODO: handle all chunks).
        ...
        for i, meter in enumerate(metergroup.submeters().meters):
            ...
            print("num_total_states ...... ",num_total_states," ",type(num_total_states))
    ...
    def disaggregate_chunk(self, mains):
        ...
        state_combinations = self.state_combinations
        print("state_combinations..........",state_combinations)
        summed_power_of_each_combination = np.sum(state_combinations, axis=1)
        print("summed_power_of_each_combination..........",summed_power_of_each_combination)
