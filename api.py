...
import pandas as pd
from disaggregate import CombinatorialOptimisation, Mean, FHMM, Zero, DAE, WindowGRU, Seq2Point, RNN
...
#                        train_df = train_df.loc[ix]    # Choosing the common timestamps
    ...
    def load_datasets(self):
        ...
        print("train mains ",self.train_mains)
    ...
    def call_predict(self,classifiers):
        ...
        for i in gt_overall.columns:
            ...
            plt.plot(pd.concat(self.test_mains,axis=1).values.flatten(),label='Input')
